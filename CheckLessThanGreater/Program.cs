...
namespace CheckLessThanGreaterThan
{
    class CheckLessThanGreatThan
    {
        int X1, X2, Y1, Y2;
        ...
        public static void Main(string[] args)
        {
            ...
            CheckLessThanGreatThan lineobject = new CheckLessThanGreatThan();
            ...
            // Checking if Both the Lines are Less than Greater than.
